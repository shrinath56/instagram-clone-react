    ...
    <>
      <div className='profile-info px-2'>
        <div className='d-flex align-items-center profile-info-1'>
          <h5 className='px-3 pt-2'>suryawanshi_shrinath</h5>
          <Link to='/accounts/edit' className='btn px-3 py-1'>
            Edit profile
          </Link>
          <svg
            style={{ cursor: "pointer" }}
            data-bs-toggle='modal'
            data-bs-target='#settingModel'
            className='mx-3'
            color='currentColor'
            fill='currentColor'
            height='24'
        ...
        <div className='d-flex align-items-center profile-info-2 mt-4'>
          ...
          <div
            className='px-3'
            data-bs-toggle='modal'
            data-bs-target='#followersModel'
          >
            <span className='numbers'>590</span>
            <Link
              to='/suryawanshi_shrinath/followers'
          ...
          <div
            className='px-3'
            data-bs-toggle='modal'
            data-bs-target='#followingModel'
          >
            <span className='numbers'>350</span>
            <Link
              to='/suryawanshi_shrinath/following'
              style={{ color: "var(--text)", textDecoration: "none" }}
            >
        ...
        <div className='profile-info-3 mt-4 px-3'>
          <h6>Shrinath Suryawanshi | Frontend Engineer</h6>
        </div>
      </div>
      <Settingmodal />
      <Followersmodal />
