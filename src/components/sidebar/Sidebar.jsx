        ...
        <>
            <div className="instagram-sidebar py-4">
                ...
                <div className="insta-menu mt-5">
                    ...
                    <Link to="/suryawanshi_shrinath" className="d-flex align-items-center px-3 py-2 mx-2 mt-3">
                        <img src={profile} alt="" style={{width:"25px",borderRadius:"50%"}} />
                        <span className="px-3" {...(window.location.pathname === '/suryawanshi_shrinath' ? {style : {fontFamily:"proximanNova-bold"}} : {})}>Profile</span>
                    </Link>
                    <div className="dropup" style={{position:"absolute",bottom:"35px",width:"100%"}}>
                        ...
                        <ul class="dropdown-menu mb-2 py-1 shadow">
                            ...
                            <li className="d-flex align-items-center py-1">
                                <Link to="/suryawanshi_shrinath/saved" class="dropdown-item">Saved</Link>
